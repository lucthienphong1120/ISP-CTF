...
First you have to know about the world these days. Read [this book](./writeupfiles/history.txt):
...
![FBpost](./writeupfiles/opengamepost.png)
...
![edit_history](./writeupfiles/edithistory.png)
...
[Dancing man](./writeupfiles/Dancing_man_cipher.png)
...
File: [magic_circle](./writeupfiles/Magic_circle.png) [spell](./writeupfiles/SPELL.png)
...
![CharacterSystem](./writeupfiles/SOLVE-EZ.png)
...
[file](./writeupfiles/sthcrypty.png)
...
![QR1](./writeupfiles/qrchickchick1.png)
...
![QRflag](./writeupfiles/qrflag.png)
...
![cmdmap](./writeupfiles/cmdmap.png)

- `grep` đối với Linux:

![termap](./writeupfiles/terminalmap.png)
...
[Challenge](./writeupfiles/chall.txt)
...
![liar](./writeupfiles/fakeflag.png)
...
[Alalalala.zip](./\writeupfiles\Alalalala.zip)
...
![chall2](./writeupfiles/chall2.png)
...
![I_DO_NOT_HIDE_ANYTHING](./writeupfiles/I_DO_NOT_HIDE_ANYTHING.jpeg)
...
[book72890](./writeupfiles/book72890.png)
...
[boduong.pas](./writeupfiles/boduong.pas)
...
![var](./writeupfiles/var.png)

Phần hàm con:

![func](./writeupfiles/func.png)

Và phần hàm main:

![main](./writeupfiles/main.png)
...
![pasrun](./writeupfiles/pasrun.png)
...
![About Us](./writeupfiles/aboutus.png)
...
Chick Chick rất thích xem Menhera, trong một lần đang xem Mehera thì bỗng nhiên bị mất mạng. [Web](https://minictf-web02.herokuapp.com/) [Source](./writeupfiles/Menhera.zip)
...
[deploy](./writeupfiles/2048deploy.zip) & [source](./writeupfiles/2048source.zip)
...
[Scroll](http://minictf.hypnguyen.us/scroll.html) [Source](./writeupfiles/Scroll.zip)
...
![Scrollhint](./writeupfiles/Scrollhint.png)
